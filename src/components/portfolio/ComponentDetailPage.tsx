  ...
  <nav className="w-full bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
    <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
      ...
      <div className="flex gap-6">
        <a href="#" className="dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">Home</a>
        <a href="#" className="dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">About</a>
        <a href="#" className="dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">Contact</a>
      </div>
    </div>
  </nav>
);
        ...
        <div className="flex gap-6">
          {links.map((link, index) => (
            <a
              key={index}
              href={link.href}
              className="dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400"
            >
              {link.label}
            </a>
          ))}
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-300">
      <div className="max-w-6xl mx-auto px-6 py-32">
        ...
        <div className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
          {activeTab === 'preview' ? (
            <div className="p-12 bg-gray-50 dark:bg-gray-800/50 min-h-[400px] flex items-center justify-center">
              {component.preview}
            </div>
          ) : (
            <div className="bg-[#1e1e1e] text-gray-100 p-6 overflow-x-auto">
